...
- (void)viewDidLoad
{
    ...
    if ([UIImagePickerController isSourceTypeAvailable: UIImagePickerControllerSourceTypeCamera]){//Three buttons
        ...
        {
            [buttonTakePhoto setCenter:CGPointMake(187,150)];
            [buttonUsePhoto setCenter:CGPointMake(187,250)];
            [buttonNoPhoto setCenter:CGPointMake(187,350)];
        }
        
        if (screenBounds.size.height == 736) // 5.5 inch
        {
            [buttonTakePhoto setCenter:CGPointMake(207,170)];
            [buttonUsePhoto setCenter:CGPointMake(207,270)];
            [buttonNoPhoto setCenter:CGPointMake(207,370)];
        }
