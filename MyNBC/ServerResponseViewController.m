...
- (void)viewDidLoad
{
    ...
    {
        [labelCallNumberText setCenter:CGPointMake(188,218)];
        [labelCallNumber setCenter:CGPointMake(188,293)];
        [labelSlaDateText setCenter:CGPointMake(188,341)];
        [labelSlaDate setCenter:CGPointMake(188,411)];
        [retryButton setCenter:CGPointMake(188,468)];
    }
    
    if (screenBounds.size.height == 736) // 5.5 inch
    {
        [labelCallNumberText setCenter:CGPointMake(207,248)];
        [labelCallNumber setCenter:CGPointMake(207,323)];
        [labelSlaDateText setCenter:CGPointMake(207,371)];
        [labelSlaDate setCenter:CGPointMake(207,441)];
        [retryButton setCenter:CGPointMake(207,498)];
    }
 ...
 qualifiedName:(NSString *)qName
{
    ...
    if ([elementName isEqualToString:@"slaDate"])
    {
        ...
        if (screenBounds.size.height == 667) // 4.7 inch
        {
            [labelCallNumberText setCenter:CGPointMake(188,178)];
            [labelCallNumber setCenter:CGPointMake(188,233)];
            [labelSlaDateText setCenter:CGPointMake(188,301)];
            [labelSlaDate setCenter:CGPointMake(188,351)];
        }
        
        if (screenBounds.size.height == 736) // 5.5 inch
        {
            [labelCallNumberText setCenter:CGPointMake(207,208)];
            [labelCallNumber setCenter:CGPointMake(207,263)];
            [labelSlaDateText setCenter:CGPointMake(207,331)];
            [labelSlaDate setCenter:CGPointMake(207,381)];
        }
